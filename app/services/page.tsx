      ...
      <section className="pt-32 pb-24 container px-6 mx-auto">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Transforming ideas into extraordinary LEGO® experiences. Each
            service is crafted with creativity, precision, and passion.
          </p>
            ...
            {[
              {
                ...
                description:
                  "Team building activities and custom installations for corporate environments.",
                image:
              ...
              },
              {
                ...
                description:
                  "Unforgettable LEGO-themed celebrations for all ages.",
                image:
              ...
              },
              {
                ...
                title: "Exhibitions",
                description:
                  "Large-scale LEGO displays and interactive installations.",
                image:
                  "https://images.pexels.com/photos/191360/pexels-photo-191360.jpeg",
                color: "#0A0F2C",
              },
              {
                icon: GraduationCap,
                ...
                description:
                  "STEM learning programs using LEGO education sets.",
                image:
              ...
              },
              {
                ...
                description:
                  "Public installations and community building activities.",
                image:
                ...
                <div className="aspect-[4/3] rounded-xl overflow-hidden mb-6 group/image">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="flex items-center gap-3 mb-2">
                      <div
                        className={`w-10 h-10 rounded-lg bg-[${service.color}] flex items-center justify-center`}
                      >
      ...
      <section className="py-24">
        <div className="container px-6 mx-auto">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Every successful event is built brick by brick with meticulous
              attention to detail.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Comprehensive planning and timeline management for flawless execution.",
                color: "#FFD700",
                features: [
                  "Concept Development",
                  "Timeline Creation",
              ...
              },
              {
                ...
                description:
                  "Expert creation and assembly of LEGO® installations and activities.",
                color: "#8A2BE2",
                features: [
                  "Custom Builds",
              ...
              },
              {
                ...
                title: "Logistics",
                description:
                  "Seamless transportation and setup of all LEGO® components.",
                color: "#0A0F2C",
                features: [
                  "Material Handling",
                  "Setup & Teardown",
              ...
              },
              {
                ...
                description:
                  "Finding the perfect space for your LEGO® experience.",
                color: "#FFD700",
                features: [
                  "Location Scouting",
                  "Space Planning",
              ...
              },
              {
                ...
                title: "Entertainment",
                description:
                  "Engaging activities and professional LEGO® facilitators.",
                color: "#8A2BE2",
                features: [
                  "Expert Builders",
                  "Interactive Games",
              ...
              },
              {
                ...
                description:
                  "Professional oversight ensuring smooth event operation.",
                color: "#0A0F2C",
                features: [
                  "Event Supervision",
                  "Guest Experience",
              ...
              <div key={feature.title} className="group relative">
                <div
                  className={`absolute inset-0 bg-[${feature.color}]/20 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300`}
                />
                <div className="bg-cta-hover rounded-xl p-6 shadow-lg relative">
                  <div
                    className={`absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-[${feature.color}] rounded`}
                  />
                  <div
                    className={`absolute -right-2 top-8 w-4 h-12 bg-[${feature.color}] rounded`}
                  />

                  <div className="flex items-start gap-4 mb-6">
                    <div
                      className={`w-12 h-12 rounded-xl bg-[${feature.color}] flex items-center justify-center flex-shrink-0`}
                    >
                  ...
                  <ul className="space-y-3">
                    {feature.features.map((item, i) => (
                      <li key={item} className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-sm bg-[${feature.color}] transform rotate-45`}
                        />
          ...
          {[
            {
              title: "Corporate Events",
              description:
                "Transform team building and corporate gatherings into engaging LEGO® experiences that foster collaboration and creativity.",
              features: [
            ...
            },
            {
              title: "Birthday Parties",
              description:
                "Create unforgettable celebrations with themed LEGO® activities and custom builds for all ages.",
              features: [
              ...
              image:
                "https://images.pexels.com/photos/7214784/pexels-photo-7214784.jpeg",
              color: "#191970",
              icon: Cake,
            },
            {
              title: "Educational Workshops",
              description:
                "Combine learning with fun through STEM-focused LEGO® programs and interactive sessions.",
              features: [
              ...
              image:
                "https://images.pexels.com/photos/8471800/pexels-photo-8471800.jpeg",
              color: "#8A2BE2",
              icon: GraduationCap,
            },
          ].map((service, index) => (
            <div key={service.title} className="mb-32 last:mb-0">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-none">
                  <div className="relative">
                    <div
                      className={`absolute -top-3 left-8 w-16 h-4 bg-[${service.color}] rounded`}
                    />
                    <div
                      className={`absolute -left-3 top-8 w-4 h-16 bg-[${service.color}] rounded`}
                    />

                    <div className="space-y-6">
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-12 h-12 rounded-xl bg-[${service.color}] flex items-center justify-center`}
                        >
                          <service.icon className="w-6 h-6 text-[#FFFFFF]" />
                        </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {service.features.map((feature, i) => (
                          <div key={feature} className="flex items-start gap-3">
                            <div
                              className={`w-6 h-6 rounded bg-[${service.color}] flex-shrink-0 transform rotate-45 mt-1`}
                            />
                ...
                <div className="relative order-1 lg:order-none">
                  ...
                  <div
                    className={`absolute -bottom-6 -right-6 w-24 h-24 bg-[${service.color}] rounded-xl transform rotate-12 -z-10`}
                  />
                  <div
                    className={`absolute -top-6 -left-6 w-16 h-16 bg-[${service.color}] rounded-xl transform -rotate-12 -z-10`}
                  />
                </div>
              </div>
            </div>
