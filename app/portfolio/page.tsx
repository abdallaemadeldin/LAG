...
import { Building2, Trophy, Star, Blocks } from 'lucide-react';
      ...
      <section className="pt-32 pb-24 container px-6 mx-auto">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Discover our collection of extraordinary LEGO® creations that have brought joy and wonder to events worldwide.
          </p>
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-6 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-300">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-6">
                        <div className="text-center">
                          <div className="text-lg font-bold text-white">{project.stats.pieces}</div>
                          <div className="text-xs text-white/70">Pieces</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-white">{project.stats.hours}</div>
                          <div className="text-xs text-white/70">Hours</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-white">{project.stats.team}</div>
      ...
      <section className="py-24">
        <div className="container px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                quote: "The team building workshop transformed our company culture. Everyone still talks about it!",
              ...
              {
                quote: "Our museum exhibition exceeded all expectations. The interactive elements were brilliant!",
              ...
              {
                quote: "The STEM workshop inspired our students. A perfect blend of education and fun!",
                author: "David Wilson",
              ...
              <div key={index} className="group relative">
                <div className={`absolute inset-0 bg-${testimonial.color}-400/20 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300`} />
                <div className="bg-cta-hover rounded-xl p-6 shadow-lg relative">
                  <div className={`absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-${testimonial.color}-400 rounded`} />
                  <div className={`absolute -right-3 top-1/2 -translate-y-1/2 w-4 h-16 bg-${testimonial.color}-400 rounded`} />
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="relative">
                      ...
                      <div className={`absolute -bottom-2 -right-2 w-6 h-6 bg-${testimonial.color}-400 rounded-lg transform rotate-12`} />
                    </div>
                    <div>
                  ...
                  <blockquote className="relative">
                    <div className={`absolute -left-2 -top-2 w-8 h-8 bg-${testimonial.color}-400/20 rounded-full`} />
          ...
          <div className="max-w-3xl mx-auto relative">
            ...
            <div className="bg-cta-hover rounded-xl p-8 shadow-lg relative">
              ...
              <div className="text-center space-y-6">
                ...
                <Link 
                  href="/contact"
                  className="inline-flex items-center gap-3 px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold rounded-xl text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg group relative"
                >
                  <div className="absolute inset-x-4 -top-2 h-2 bg-yellow-500 rounded-t-lg transform group-hover:-translate-y-0.5 transition-transform" />
                  Let's Build Your Dream Project!
                  <Blocks className="w-6 h-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all" />
                  <div className="absolute inset-x-4 -bottom-2 h-2 bg-yellow-300 rounded-b-lg transform group-hover:translate-y-0.5 transition-transform" />
                </Link>
              </div>
            </div>
          </div>
