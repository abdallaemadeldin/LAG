import { Trophy, Users, Rocket, Blocks, HeartHandshake } from "lucide-react";
      ...
      <section className="pt-24 pb-16 container px-6 mx-auto">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Building connections through the power of LEGO® creativity since
            2020.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground">
                LAG Agency was born from a simple idea: to bring people together
                through the universal language of LEGO®. What started as a small
                team of enthusiasts has grown into a full-service event agency,
                specializing in creating unforgettable LEGO® experiences.
              </p>

              <p className="text-muted-foreground">
                Our mission is simple: to unlock creativity and foster
                connections through the power of LEGO®. Whether it's team
                building, educational workshops, or large-scale installations,
                we believe every brick placed is an opportunity to inspire,
            ...
            {[
              {
                ...
                title: "Creativity",
                description:
                  "We believe in the power of imagination to transform events into memorable experiences.",
              },
              {
                icon: Users,
                color: "#191970",
                title: "Collaboration",
                description:
                  "Working together with our clients to build something extraordinary.",
              },
              {
                icon: Rocket,
                color: "#0A0F2C",
                title: "Innovation",
                description:
                  "Pushing boundaries to create unique and engaging LEGO experiences.",
              },
              {
                icon: Trophy,
                color: "#121212",
                title: "Excellence",
                description:
                  "Committed to delivering the highest quality in every brick we place.",
              },
            ].map((value, index) => (
              <div key={value.title} className="group relative">
                <div
                  className={`absolute inset-0 bg-[${value.color}]/20 rounded-xl -rotate-6 scale-[0.98] opacity-0 group-hover:opacity-100 transition-all duration-300`}
                />
                <div
                  className={`bg-[${value.color}] p-6 rounded-xl shadow-lg relative`}
                >
                  <div
                    className={`bg-[${value.color}] w-12 h-3 absolute -top-1.5 left-8 rounded opacity-50`}
                  />
                  <value.icon className="w-8 h-8 mb-4 text-[#FFFFFF]" />
                  <h3 className="font-semibold text-xl mb-2 text-[#FFFFFF]">
                    {value.title}
                  </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="group relative">
                <div
                  className={`absolute inset-0 bg-[${stat.color}]/20 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300`}
                />
                <div className="bg-cta-hover rounded-xl p-6 shadow-lg relative">
                  <div
                    className={`absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-[${stat.color}] rounded`}
                  />
                  <div
                    className={`absolute -bottom-3 left-1/2 -translate-x-1/2 w-12 h-3 bg-[${stat.color}] rounded opacity-50`}
                  />
                  ...
                  <div className="absolute -right-2 top-1/2 -translate-y-1/2 space-y-1">
                    <div
                      className={`w-2 h-2 rounded-full bg-[${stat.color}]`}
                    />
                    <div
                      className={`w-2 h-2 rounded-full bg-[${stat.color}]`}
                    />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                role: "Technical Lead",
                funFact:
                  "Holds a world record for speed-building the Death Star",
                color: "#8A2BE2",
                image:
              ...
              <div key={member.name} className="group relative">
                <div
                  className={`absolute inset-0 bg-[${member.color}]/20 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300`}
                />
                <div className="bg-cta-hover rounded-xl p-6 shadow-lg relative">
                  <div className="relative mb-6">
                    ...
                    <div
                      className={`absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-[${member.color}] rounded`}
                    />
                    <div
                      className={`absolute -bottom-3 left-1/2 -translate-x-1/2 w-12 h-3 bg-[${member.color}] rounded opacity-50`}
                    />
                    <div
                      className={`absolute -right-3 top-1/2 -translate-y-1/2 w-3 h-12 bg-[${member.color}] rounded`}
                    />
                    <div
                      className={`absolute -left-3 top-1/2 -translate-y-1/2 w-3 h-12 bg-[${member.color}] rounded`}
                    />
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-border">
                    <div className="flex items-start gap-3">
                      <div
                        className={`w-8 h-8 rounded bg-[${member.color}] flex-shrink-0 flex items-center justify-center`}
                      >
            ...
            {[
              {
                ...
                quote:
                  "The team building workshop was transformative. Our employees still talk about it months later!",
                image:
              ...
              },
              {
                ...
                quote:
                  "LAG brought our conference to life with their interactive LEGO installations. Simply incredible!",
                image:
              ...
              },
              {
                ...
                quote:
                  "The educational value combined with pure fun made our STEM week unforgettable for students.",
                image:
                  "https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg",
                color: "#0A0F2C",
              },
              ...
              <div key={testimonial.name} className="group relative">
                <div
                  className={`absolute inset-0 bg-[${testimonial.color}]/20 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300`}
                />
                <div className="bg-cta-hover rounded-xl p-6 shadow-lg relative">
                  <div
                    className={`absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-[${testimonial.color}] rounded`}
                  />
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="relative">
                      ...
                      <div
                        className={`absolute -bottom-2 -right-2 w-6 h-6 bg-[${testimonial.color}] rounded-lg transform rotate-12`}
                      />
                    </div>
                    <div>
                  ...
                  <blockquote className="relative">
                    <div
                      className={`absolute -left-2 -top-2 w-8 h-8 bg-[${testimonial.color}]/20 rounded-full`}
                    />
